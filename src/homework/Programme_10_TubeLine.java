package homework;
/**
 * Write the Java programme that tell you which line pass through particular stations . Just use Zone 1 stations name.
 */
...
public class Programme_10_TubeLine {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(tubeStationZone1.lagth); // for debug purpose
        ...
        System.out.println("Please emter the tube station's name of Zone 1 :");
...
//Logic to find the Line names form the given input from the user
        if (userTubeStation.equalsIgnoreCase(catchStationName)) {
            ...
            System.out.println("---------------------------------------------------------------------------");
            //System.out println (lodonUGLines.length) ; // for debug purpose
